  ...
  return (
    <div className="page-container">
      <div className="page-header">
        <h1 className="page-title"><span>👟</span> Joueurs</h1>
                ...
                <tr key={player.id}>
                  ...
                  <td>
                    <div className="action-buttons" style={{ justifyContent: 'center' }}>
                      <button className="btn-edit" onClick={() => openEdit(player)}>✏️ Modifier</button>
                      <button className="btn-danger" onClick={() => handleDelete(player)}>🗑️</button>
                    </div>
                  </td>
                </tr>
              ))}
        ...
        <div className="modal-overlay" onClick={closeModal}>
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            <h2 className="modal-title">
              {editingId ? '✏️ Modifier le joueur' : '➕ Nouveau joueur'}
            </h2>
