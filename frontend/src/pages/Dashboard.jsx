...
export default function Dashboard() {
  ...
  const kpis = [
    { icon: '🛡️', label: 'Équipes',        value: totalTeams },
    { icon: '⚽', label: 'Matchs joués',   value: Math.round(totalMatches) },
    { icon: '🎯', label: 'Buts total',     value: totalGoals },
    { icon: '🏆', label: 'Leader',         value: leader },
  ]
          ...
          <div style={{
            ...
            <div style={chartCardStyle}>
              <div style={chartTitleStyle}>
                <span>🎯</span> Buts marqués par équipe
              </div>
